# Requisitos do Sistema FitPass Gym Management

Considerando os requisitos funcionais do Sistema FitPass Gym Management, elabore o diagrama de classes do domínio.
